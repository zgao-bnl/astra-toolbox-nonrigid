...
#ifndef _INC_ASTRA_CUDAFORWARDPROJECTIONALGORITHM3D_DF
#define _INC_ASTRA_CUDAFORWARDPROJECTIONALGORITHM3D_DF
...
class _AstraExport CCudaForwardProjectionAlgorithm3D_DF : public CAlgorithm
{
public:
	 ...
	 */
	CCudaForwardProjectionAlgorithm3D_DF();
	
	/** Destructor.
	 */
	virtual ~CCudaForwardProjectionAlgorithm3D_DF();
...
// inline functions
inline std::string CCudaForwardProjectionAlgorithm3D_DF::description() const { return CCudaForwardProjectionAlgorithm3D_DF::type; };
