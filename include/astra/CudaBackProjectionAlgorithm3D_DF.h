...
#ifndef _INC_ASTRA_CUDABACKPROJECTIONALGORITHM3D_DF
#define _INC_ASTRA_CUDABACKPROJECTIONALGORITHM3D_DF
...
class _AstraExport CCudaBackProjectionAlgorithm3D_DF : public CReconstructionAlgorithm3D {
...
public:
	 ...
	 */
	CCudaBackProjectionAlgorithm3D_DF();
	 ...
	 */
	CCudaBackProjectionAlgorithm3D_DF(CProjector3D* _pProjector, 
	                     CFloat32ProjectionData3D* _pProjectionData, 
	                     CFloat32VolumeData3D* _pReconstruction);
	
	/** Copy constructor.
	 */
	CCudaBackProjectionAlgorithm3D_DF(const CCudaBackProjectionAlgorithm3D_DF&);

	/** Destructor.
	 */
	virtual ~CCudaBackProjectionAlgorithm3D_DF();
...
protected:
	...
	CFloat32VolumeData3D* m_pDeformX;
	CFloat32VolumeData3D* m_pDeformY;
	CFloat32VolumeData3D* m_pDeformZ;
...
// inline functions
inline std::string CCudaBackProjectionAlgorithm3D_DF::description() const { return CCudaBackProjectionAlgorithm3D_DF::type; };
